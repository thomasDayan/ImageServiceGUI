...
export class UploadDetailsSearchRoomie extends Component {
  constructor(props) {
    super(props);
  ...
  handleChangeAdress = name => (e, value) => {
    ...
    return (
      <form padding={20}>
        <Grid container spacing={1}>
          ...
          <Grid item xs={3}>
            <Typography>Upload a pictures </Typography>
          </Grid>
          <Grid item xs={3}>
            <input
              accept="image/*"
          ...
          <Grid item xs={12}>
            ...
            <TextField
              ...
              style={{ top: "-20%", width: "50%" }}
            ></TextField>
          </Grid>

          <Typography>
            Consider your roomates as OCD persons ? 1 to 5
          </Typography>
          <Slider
            defaultValue={0}
...
export default UploadDetailsSearchRoomie;
